...
<div class="wrapper" >
  ...
  <div class="content" style="padding-bottom: 30px;background-image:url('img/sandart.jpg');height: 100%; background-position: center;
    ...
    <br>
	   <center>
	<a href="login_reg/process.php?id=4" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Participate</a></center><br/><br/>
