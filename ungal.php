...
<div class="wrapper" >
  ...
  <div class="content" style="background-color: #6d1d1d; padding-bottom: 30px;">
        <h1 style="color:#FFF68F">                                          UNGAL: FINGER PAINTING
                                              (Let Your Finger Create )
...
This event is the one to remind you about your childhood. No childhood is complete without some good, messy and squishy finger painting. Come and relive your old days, grab the chance to bring out that hidden artist in you.
      </p>
<h3 style="color: #FF6666">Rules:</h3>
      <p style="color:#FFF68F">

1.You'll go single in this event.<br>
2. This is a theme based event ,so you will get your theme on spot.<br>
3. Sheets and Rangeela colours will be provided on spot.<br>
4. Time to complete the painting is two hours.<br>
<br>
<br>
...
NOTE: EACH TEAM MEMBER HAS TO REGISTER INDIVIDUALLY.<br>
   ...
   <br>
	<a href="login_reg/process.php?id=3" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Participate</a>
