...
<div class="wrapper" >
  ...
  <div class="content" style="background-color: #f48042; padding-bottom: 30px;">
        <h1 style="color:#FFF68F">                                                 PIC CHARADES                                            (#The Transit Tableau) 
...
This is a classic charades event with a twist. All that matters is your creativity but on a paper. Come and show us that creativity which is oozing out of you artistically.
...
1. It is a team event with a team size of 4 members.<br>
2. It consists of two rounds in which first round will be elimination round.<br>
<br>
Round 1:<br>
<br>
•	Every member of the team will be given a word which they have to describe their  team members by making a picture.<br>
•	The picture made should not contain the given word itself.<br>
<br>
<br>
Round 2:<br>
<br>
All the rules will be same as of the first round with an increased difficulty level.<br>
...
Worth 7k<br>
   ...
   <br>
	<a href="login_reg/process.php?id=10" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Participate</a>
