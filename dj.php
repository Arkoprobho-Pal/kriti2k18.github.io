...
<div class="wrapper" >
  ...
  <div class="content" style="padding-bottom: 30px;background-image:url('img/dj11.jpg');height: 100%; background-position: center;
    background-repeat: no-repeat;
    background-size: contain;">
        
    </div>
     <center>
	<a href="login_reg/process.php?id=15" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">I will attend</a></center><br/><br/>
