...
<div class="wrapper" >
  ...
  <div class="content" style="padding-bottom: 30px;background-image:url('img/DANCE1.jpg');height: 100%; background-position: center;
    background-repeat: no-repeat;
    background-size: contain;">
        
    
     </div><div> <br>
	<center><a href="login_reg/process.php?id=5" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Participate</a></center>
<br>
     <br>
    </div>
    </div>
