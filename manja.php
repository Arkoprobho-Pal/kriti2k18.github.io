...
<div class="wrapper" >
	...
	<nav>
		...
		<div class="menu">
			<ul>
				...
				<li><a href="http://scagekriti2k18.com/#sponsor">Sponsors</a></li>
  ...
  <div class="content" style="background-color: #6d1d1d; padding-bottom: 30px;">
        <h1 style="color:#FFF68F">MANJHA: KITE  DESIGNING
...
Kite flying has always been a thing of excitement in your childhood, we now intend to provide you the same joy of making your kite. Scale the skies just with a small change,  you will design your own kite. Sounds interesting, then come in large numbers and make most of the chance to relive your childhood. 
      </p>
<h3 style="color: #FF6666">Rules:</h3>
      <p style="color:#FFF68F">

1. It's a team event with 2 members.<br>
2. All materials required for preparing a kite will be provided like craft paper, sticks and glue.<br>
3. Both the members have to make a Kite within 2 hrs.<br>
4. The teams are expected to fly their Kites and they'll be judged both aesthetically and functionally. <br>
4. Judgement  will be given on the basis of both criteria.<br>
...
NOTE: EACH TEAM MEMBER HAS TO REGISTER INDIVIDUALLY.<br>
  ...
  <br>
	<a href="login_reg/process.php?id=1" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Participate</a>
