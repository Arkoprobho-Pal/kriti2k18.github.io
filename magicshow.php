...
<div class="wrapper" >
  ...
  <div class="content" style="padding-bottom: 30px;background-image:url('img/magicshow.jpg');height: 100%; background-position: center;
    ...
    background-size: contain;">
     ...
     <br><br>
	   <center>
	<a href="login_reg/process.php?id=16" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">I will attend</a></center><br/><br/>
