...
<div class="wrapper" >
  ...
  <div class="content" style="padding-bottom: 30px;background-image:url('img/magicwork.jpg');height: 100%; background-position: center;
    ...
    background-size: contain;">
     ...
     <div> <br>
	<center><a href="login_reg/process.php?id=6" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Participate</a></center>
<br>
     <br>
    </div>
    </div>
